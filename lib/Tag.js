...
var Tag = /** @class */ (function () {
    ...
    Tag.prototype.write = function (stream, vrType, values, syntax) {
        ...
        var implicit = useSyntax == IMPLICIT_LITTLE_ENDIAN ? true : false, isLittleEndian = useSyntax == IMPLICIT_LITTLE_ENDIAN ||
            useSyntax == EXPLICIT_LITTLE_ENDIAN
            ? true
            : false, isEncapsulated = DicomMessage.isEncapsulated(syntax);
