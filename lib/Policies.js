...
function ctImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), frameOfReferenceModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePlaneModulePolicy(), imagePixelModulePolicy(), ctImageModulePolicy(), voiLutModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
