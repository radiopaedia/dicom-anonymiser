...
function ctImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), dxImageModulePolicy(), frameOfReferenceModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePlaneModulePolicy(), imagePixelModulePolicy(), ctImageModulePolicy(), voiLutModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function mrImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), dxImageModulePolicy(), frameOfReferenceModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePlaneModulePolicy(), imagePixelModulePolicy(), mrImageModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function ultrasoundImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), generalEquipmentModulePolicy(), dxImageModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), ultrasoundImageModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function xRayAngiographicImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), dxImageModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), xRayImageModulePolicy(), xRayAcquisitionModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function xRayRadiofluoroscopicImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), generalEquipmentModulePolicy(), dxImageModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), xRayImageModulePolicy(), xRayAcquisitionModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
