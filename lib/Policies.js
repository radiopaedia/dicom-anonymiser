...
function addPolicies() {
    ...
    if (policies.length < 1) {
        return { "default": { "action": "remove", "description": "remove EVERYTHINNNGG!!!" } };
    }
...
function generalImageModulePolicy() {
    return {
...
function cineModulePolicy() {
    return {
        ...
        "003A0300": { "action": "replace", "value": [], "description": "Multiplexed Audio Channels Description" }
    };
}
...
function paletteColorLookupTablePolicy() {
    return {
        ...
        "00281103": { "action": "keep", "description": "Blue Palette Color Lookup Table Descriptor" },
        "00281201": { "action": "keep", "description": "Red Palette Color Lookup Table Data" },
        "00281202": { "action": "keep", "description": "Green Palette Color Lookup Table Data" },
        "00281203": { "action": "keep", "description": "Blue Palette Color Lookup Table Data" },
        "00281221": { "action": "keep", "description": "Segmented Red Palette Color Lookup Table Data" },
        "00281222": { "action": "keep", "description": "Segmented Blue Palette Color Lookup Table Data" },
        "00281223": { "action": "keep", "description": "Segmented Green Palette Color Lookup Table Data" }
    };
}
...
function mrImageModulePolicy() {
    return {
        ...
        "00180080": { "action": "replace", "value": [], "description": "Repetition Time" },
        "00180081": { "action": "replace", "value": [], "description": "Echo Time" },
        "00180091": { "action": "replace", "value": [], "description": "Echo Train Length" },
...
function enhancedGeneralEquipmentModulePolicy() {
    return {
        ...
        "00181000": { "action": "replace", "value": ["REMOVED"], "description": "Device Serial Number" },
        "00181020": { "action": "replace", "value": ["REMOVED"], "description": "Software Versions" }
    };
}
function multiframeFunctionalGroupsSequenceModulePolicy() {
    return {
        ...
        "00080033": { "action": "replace", "value": ["0000"], "description": "Content Time" },
        "00280008": { "action": "keep", "description": "Number of Frames" }
    };
}
...
function mrSpectroscopyModulePolicy() {
    return {
        ...
        "00089207": { "action": "keep", "description": "Volume Based Calculation Technique" },
        ...
        "00189063": { "action": "keep", "description": "Decoupling Chemical Shift Reference" },
        ...
        "00189199": { "action": "keep", "description": "Water Referenced Phase Correction" }
...
function mrSpectroscopyDataModulePolicy() {
    return {
        ...
        "56000010": { "action": "keep", "description": "First Order Phase Correction Angle" },
...
function xRayAcquisitionModulePolicy() {
    return {
        ...
        "00181151": { "action": "replace", "value": [], "description": "X-Ray Tube Current" },
...
function xRay3DImageModulePolicy() {
    return {
        ...
        "00282114": { "action": "keep", "description": "Lossy Image Compression Method" },
        "20500020": { "action": "keep", "description": "Presentation LUT Shape" }
    };
}
...
function nmImageModulePolicy() {
    return {
        "00080008": { "action": "keep", "description": "Image Type" },
        "00282110": { "action": "keep", "description": "Lossy Image Compression" },
        "00180070": { "action": "replace", "value": [], "description": "Counts Accumulated" },
...
function petSeriesModulePolicy() {
    return {
        ...
        "00181181": { "action": "replace", "value": [], "description": "Collimator Type" }
    };
}
...
function petImageModulePolicy() {
    return {
        ...
        "00080022": { "action": "replace", "value": [], "description": "Acquisition Date" },
        "00080032": { "action": "replace", "value": [], "description": "Acquisition Time" },
        "00181242": { "action": "replace", "value": [], "description": "Actual Frame Duration" },
...
function digitalXRayPolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), dxSeriesModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), dxAnatomyImagedModulePolicy(), dxImageModulePolicy(), dxDetectorModulePolicy(), acquisitionContextModulePolicy(), sopCommonModulePolicy(), {
...
function digitalMammographyXRayPolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), dxSeriesModulePolicy(), mammographySeriesModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), dxAnatomyImagedModulePolicy(), dxImageModulePolicy(), dxDetectorModulePolicy(), mammographyImageModulePolicy(), acquisitionContextModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function ctImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), frameOfReferenceModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePlaneModulePolicy(), imagePixelModulePolicy(), ctImageModulePolicy(), dxImageModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function mrImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), frameOfReferenceModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePlaneModulePolicy(), imagePixelModulePolicy(), mrImageModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function ultrasoundImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), ultrasoundImageModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function xRayAngiographicImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePixelModulePolicy(), xRayImageModulePolicy(), xRayAcquisitionModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
...
function positronEmissionTomographyImagePolicy() {
    ...
    return addPolicies(patientModulePolicy(), generalStudyModulePolicy(), generalSeriesModulePolicy(), petSeriesModulePolicy(), petIsotopeModulePolicy(), nmPETPatientOrientationModulePolicy(), frameOfReferenceModulePolicy(), generalEquipmentModulePolicy(), generalImageModulePolicy(), imagePlaneModulePolicy(), imagePixelModulePolicy(), petImageModulePolicy(), sopCommonModulePolicy(), {
        "default": { "action": "remove", "description": "The default policy is to remove unspecified tags" },
        "00080016": { "action": "replace", "value": [classUID], "description": "SOP Class UID" }
    });
}
